...
<head>
    ...
    <title>Профессиональное кухонное оборудование</title>
        ...
        <div class="container">
            ...
            <div class="pull-right">
                <ul class="nav navbar-nav navbar-right">
                    @if(auth()->check())
                        <li><a href="{{ route('accounts', ['tab' => 'profile']) }}"><i class="fa fa-home"></i> Мой аккаунт</a></li>
                        <li><a href="{{ route('logout') }}"><i class="fa fa-sign-out"></i> Выйти</a></li>
                    @else
                        <li><a href="{{ route('login') }}"> <i class="fa fa-lock"></i> Войти</a></li>
                        <li><a href="{{ route('register') }}"> <i class="fa fa-sign-in"></i> Регистрация</a></li>
                    @endif
        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div class="navbar-header col-md-2">
                    ...
                    <a style="font-size:30px;cursor:pointer" href="{{ route('home') }}">VINIKS</a>
