                            ...
                            <div class="vcenter">
                                <div class="centrize">
                                    <ul class="list-unstyled list-group">
                                        ...
                                        <li>  <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal_{{ $product->id }}"> <i class="fa fa-eye"></i> Просмотреть</button>
                                        <li>  <a class="btn btn-default product-btn" href="{{ route('front.get.product', str_slug($product->slug)) }}"> <i class="fa fa-link"></i> Перейти к продукту</a> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
@else
    <p class="alert alert-warning">У вас еще нет продуктов.</p>
@endif