...
{{--                        <input type="text" name="country_id" id="country_id" placeholder="Country" class="form-control" value="{{ old('country_id') }}">--}}
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('accounts', ['tab' => 'address']) }}" class="btn btn-default">Назад</a>
