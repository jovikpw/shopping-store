        ...
        <div class="box">
            <form action="{{ route('customer.address.store', $customer->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="address_1">Адрес 1 <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="province_id">Область </label>
                    ...
                    <div class="form-group">
                        <label for="zip">Почтовый адрес </label>
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('customer.address.index', $customer->id) }}" class="btn btn-default">Назад</a>
