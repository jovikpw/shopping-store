                ...
                <div class="col-md-12 content">
                    ...
                    @if(count($addresses) > 0)
                        ...
                        @if(isset($addresses))
                            <div class="row">
                                <div class="col-md-12">
                                    <legend><i class="fa fa-home"></i> Адреса</legend>
                        ...
                        @if(!is_null($rates))
                            <div class="row">
                                <div class="col-md-12">
                                    <legend><i class="fa fa-truck"></i> Курьер</legend>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <legend><i class="fa fa-credit-card"></i> Оплата</legend>
                                @if(isset($payments) && !empty($payments))
                                    <table class="table table-striped">
                                        <thead>
                                        <th class="col-md-4">Название</th>
                                        <th class="col-md-4">Описание</th>
                                        <th class="col-md-4 text-right">Выберите способ оплаты</th>
                                        </thead>
                                        <tbody>
                                ...
                                @else
                                    <p class="alert alert-danger">Не выбран способ оплаты</p>
                                @endif
                            </div>
                        </div>
                    @else
                        <p class="alert alert-danger"><a href="{{ route('customer.address.create', [$customer->id]) }}">У вас не найдено сохранненых адресов. Создайте!</a></p>
                    @endif
                </div>
            </div>
        @else
            <div class="row">
                <div class="col-md-12">
                    <p class="alert alert-warning">У вас еще нет заказов. <a href="{{ route('home') }}">Закажите сейчас!</a></p>
                </div>
            </div>
        @endif
    </div>
