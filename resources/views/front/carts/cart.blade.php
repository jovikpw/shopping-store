...
@section('content')
        <div class="container product-in-cart-list">
            @if(!$cartItems->isEmpty())
                ...
                <div class="row">
                    <div class="col-md-12 content">
                        ...
                        <h3><i class="fa fa-cart-plus"></i> Корзина</h3>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row hidden-xs hidden-sm" style="height: 40px;">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><b>Фото</b></div>
                                </div>
                            </div>

                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
                                <div class="row">
                                    <div class="col-lg-5 col-md-5"><b>Название</b></div>
                                    <div class="col-lg-2 col-md-2"><b>Количество</b></div>
                                    <div class="col-lg-1 col-md-1"><b>Убрать</b></div>
                                    <div class="col-lg-2 col-md-2"><b>Цена</b></div>
                                    <div class="col-lg-2 col-md-2"><b>Итого</b></div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-8">
                                            <form action="{{ route('cart.update', $cartItem->rowId) }}" class="form-inline" method="post">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-btn"><button class="btn btn-default btn-sm">Обновить</button></span>
                                                </div>
                                            </form>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 content">
                        <table class="table table-striped">
                            <tfoot>
                                <tr>
                                    <td class="bg-warning">Промежуточный итог</td>
                                ...
                                <tr>
                                    <td class="bg-warning">Цена доставки</td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                    <td class="bg-warning"></td>
                                ...
                                <tr>
                                    <td class="bg-success">Итоговая сумма</td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right">
                                    <a href="{{ route('home') }}" class="btn btn-default">Продолжить покупку</a>
                                    <a href="{{ route('checkout.index') }}" class="btn btn-primary">Перейти к покупке</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @else
                <div class="row">
                    <div class="col-md-12">
                        <p class="alert alert-warning">Вы еще не заказали товары <a href="{{ route('home') }}">Закажите сейчас!</a></p>
                    </div>
                </div>
            @endif
        </div>
