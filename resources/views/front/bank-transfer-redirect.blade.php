                ...
                <form action="{{ route('bank-transfer.store') }}" class="form-horizontal" method="post">
                    ...
                    <div class="col-md-6">
                        <div class="box-body">
                            ...
                            <hr>
                            <div class="btn-group">
                                <a href="{{ route('checkout.index') }}" class="btn btn-default">Назад</a>
                                <button onclick="return confirm('Вы уверены?')" class="btn btn-primary">Оплатить через банк или наличными</button>
